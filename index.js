...
export default class SignaturePad extends Component {
  ...
  static propTypes = {
    ...
    strokeWidthMin: PropTypes.number,
    strokeWidthMax: PropTypes.number,
  };
  ...
  constructor(props) {
    ...
    var injectedJavaScript = injectedExecuteNativeFunction
      ...
      + injectedApplication(props.penColor, backgroundColor, props.dataURL, props.strokeWidthMin, props.strokeWidthMax);
